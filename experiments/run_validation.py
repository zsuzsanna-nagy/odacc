...
EXPERIMENTS = [
    # comprehensive
    {
        ...
        "backend_sets": ["symbolic_smt", "smt_smt"],
        "mode": "both",
        "warmups": 0,
        "repetitions": 1,
        "offline_timeout": 600,
